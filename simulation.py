...
def run_simulation(simulation_time, numNodes, contentionWindowSize, delay):
    ...
    def contention_process(cluster_head):
        collision_slots, booked_slots, idle_slots, avg_send, fail_trans, succ_trans = cluster_head.analyze_slots()
        return collision_slots, booked_slots, idle_slots, avg_send, fail_trans, succ_trans
    ...
    coll_slot, booked_slot, idle_slot, avg_send, fail_trans, succ_trans = contention_process(cluster_head)
    ...
    succ_trans = succ_trans/contentionWindowSize
